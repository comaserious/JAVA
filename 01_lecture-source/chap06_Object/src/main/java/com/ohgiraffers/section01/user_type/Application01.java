...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  3. 리턴은 한개의 값만 가능하기 때문에 회원 정보를 묶어서 리턴 값으로 활용할 수 없다
        *      (서로 다른 자료형이기 때문에)*/
        ...
        /*필기.
        *  (사용자정의)자료형 변수명 = new 클래스명(); <-지금까지 사용한 이 구문은 객체(instance)를 생성하는 구문이다
        ...
        *  클래스에 작성한 내용대로 사용할수 있다*/

        Member member = new Member();     //클래스자체가 자료형이 되는 거다

        /*목차. 2-2. 생성된 인스턴스의 초기값 확인하기*/

        /*필기.
        *  이렇게 위에서처럼 객체를 생성하고 나면, 서로 다른 자료형들은 하나의 member라는 변수명으로
        *  관리할 수 있도록 공간을 생성한 것이다
        *  heap 이라는 공간에 생성되기 때문에 jvm이 제공하는 기본값들로 초기화된다*/

        /*필기.
        *  필드에 접근하기 위해서는 레퍼런스변수명.필드명 <-이렇게 접근한다
        *  '.' 참조연산자 라고 하는데, 레퍼런스변수명가 참조하고 있는 주소에 접근하겠다라는 의미
        * */
